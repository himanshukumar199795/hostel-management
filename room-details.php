...
<td><a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/hostel/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print Data</a><br>
<a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/hostel/proc.php?name=<?php echo $row->firstName;?>');" title="View Full Details">procedure data</a></td>
</tr>
<tr>
